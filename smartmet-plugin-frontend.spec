...
#TestRequires: smartmet-library-spine >= 26.6.24
#TestRequires: smartmet-server >= 26.6.24
#TestRequires: smartmet-engine-sputnik >= 26.6.24
...
* Mon Nov 10 2025 Andris Pavēnis <andris.pavenis@fmi.fi> 25.11.10-1.fmi
- Update handling of info request 'qengine'
...
- Handle admin requests through SmartMet::Spine::ContentHandlerView
...
- Add host name and client IP to stack traces
